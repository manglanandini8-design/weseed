...
{analysis && (
  ...
  <div style={{ fontSize: 10, color: 'var(--text-dim)' }}>Auto-detected</div>
        ...
        <div style={{ padding: '0 20px 16px' }}>
          ...
          <textarea placeholder="Describe what you see..." value={note}
onChange={(e)=>setNote(e.target.value)}style={{ width: '100%', background: 'rgba(255,255,255,0.02)', border: '0.5px solid rgba(255,255,255,0.07)', borderRadius: 12, padding: '10px 12px', fontSize: 13, fontFamily: 'inherit', color: 'var(--text-primary)', resize: 'none', outline: 'none' }} rows={3} />
        </div>
